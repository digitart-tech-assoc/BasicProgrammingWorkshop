...
<details><summary>`Q13[B][Day3]_Anka+`模範解答</summary>
...
while(true){
    ...
    //  条件に合うか確認
    if( isFitBudget(budget, total_cost) ){
        break 
    }
...
---
[答え](../Exercises_answers/Day4/Q16[A][Day4]_Anka+isChild.js)

[次の問題へ進む](Q17[A][Day4]_Anka+isAdult.md)  
